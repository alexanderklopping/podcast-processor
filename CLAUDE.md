...
- API keys loaded from `.env` file or 1Password (local), or environment variables (cloud). Required: `OPENAI_API_KEY` for language tasks and `GROQ_API_KEY` for the default transcription route.
